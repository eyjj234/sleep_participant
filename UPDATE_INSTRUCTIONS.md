...
2. **6단계: 데이터 제출** - 데이터 제공 동의 후 제출
3. **7단계: 매니저 데이터 확인** - 매니저 검토 대기
4. **8단계: 기기 반납 준비** (기존 5단계에서 이동)
5. **9단계: 완료!** (기존 6단계에서 이동)
...
| B | 이름 | 참가자 이름 |
| C | 기기번호 | 1-10 |
| D | 현재상태 | 대기중, 발송완료, 수령완료, 수집중, 수집완료, 데이터확인완료, 데이터제출완료, 매니저확인완료, 회수대기, 회수완료 |
| E | 등록일 | |
| F | 수령일 | |
| G | 연동완료일 | |
| H | 수집시작일 | |
...
| J | 데이터확인일 | 5단계 완료 시 |
| K | 데이터제출일 | 6단계 완료 시 |
| L | 매니저확인일 | 7단계 완료 시 (매니저가 직접 업데이트) |
| M | ... | |
